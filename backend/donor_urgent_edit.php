...
$query_permohonan = "UPDATE permohonan_pasien SET nama_pasien = '$nama_pasien', nama_rumah_sakit = '$nama_rumah_sakit', lokasi_pasien = '$lokasi_pasien', golongan_darah = '$golongan_darah', rhesus = '$rhesus', jumlah_pendonor = '$jumlah_pendonor', jenis_donor_darah = '$jenis_donor_darah' WHERE id = '$id'";
